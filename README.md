...
## Implementation  
1. Models: KNN + LogistRegression + DecissionTree + LightGBM (RandomForest + GBDT) +  SVM
2. Tools: Python 3.14, scikit-learn, pandas, lightgbm, matplotlib,
3. Key Steps:  
...
## Team & Roles  
1. Class: Class 1, Software Engineering, Grade 2024, Fujian Normal University  
2. Members: Jiamo Song, Yuchen Weng, Mengcheng He, Shengjie He, Xinrui Lin, Zhitao Zhang  
3. Roles: 
Jiamo Song: 
